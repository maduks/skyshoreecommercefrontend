          ...
          <div className="container">
            <div className="breadcrumb-content">
              ...
              <ul>
                ...
                <li><TransitionLink href={createLocaleUrl('/categories')}>Catalog</TransitionLink></li>
      ...
      <div className="breadcrumb-area">
        <div className="container">
          <div className="breadcrumb-content">
            ...
            <ul>
              <li><TransitionLink href={createLocaleUrl('/')}>{tNav('home')}</TransitionLink></li>
              <li><TransitionLink href={createLocaleUrl('/catalog')}>Catalog</TransitionLink></li>
                    ...
                    <ul className="module-list_item">
                      ...
                      {categories.length > 0 ? (
                        categories.map((category: Category) => (
                          <li key={category._id}>
                            <TransitionLink 
                              href={createLocaleUrl(`/catalog/${encodeURIComponent(category.name.toLowerCase().replace(/\s+/g, '-'))}`)}
                        ...
                        <li>
                          <a href="javascript:void(0)">Loading catalogs...</a>
                        </li>
                      )}
                    </ul>
                  </div>
                      ...
                      <div className="inner-slide">
                        <div className="single-product">
                          <div className="product-img">
                            <TransitionLink href={createLocaleUrl(`/catalog/${resolvedParams?.category}/${product._id}`)}>
                              <Image 
                          ...
                          <div className="product-content">
                            <div className="product-desc_info">
                              ...
                              <h6>
                                <TransitionLink className="product-name" href={createLocaleUrl(`/catalog/${resolvedParams?.category}/${product._id}`)}>
                                  {product.name}
                                </TransitionLink>
                              </h6>
