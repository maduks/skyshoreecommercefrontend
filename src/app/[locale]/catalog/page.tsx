...
const CategoriesPage = () => {
  ...
  useScriptLoader({
    ...
    onLoad: () => {
      console.log('Scripts loaded successfully for categories page');
      // Initialize categories page specific functionality
  ...
  const initializeCategoriesPage = () => {
  ...
  // Initialize categories functionality only once when products load
  useEffect(() => {
          ...
          <div className="container">
            <div className="breadcrumb-content">
              ...
              <ul>
                ...
                <li className="active">Products Catalog</li>
              </ul>
            </div>
          </div>
        </div>
                ...
                {products.map((product: any) => (
                  <div key={product._id} className={
                    ...
                    <div className="list-slide_item">
                      <div style={{borderRadius:20}} className="single-product">
                        <div className="product-img">
                          <TransitionLink href={createLocaleUrl(`/product/${product._id}`)}>
                            <Image 
                              className="primary-img" 
