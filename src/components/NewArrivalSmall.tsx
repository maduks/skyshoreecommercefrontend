...
const NewArrivals = () => {
  ...
  // Filter products with featured-small tag
  const newArrivalProducts = products.filter((product: Product) => {
    const hasFeaturedSmallTag = product.tags && product.tags.includes('featured-small');
    console.log('Product:', product.name, 'Tags:', product.tags, 'Has featured-small:', hasFeaturedSmallTag);
    return hasFeaturedSmallTag;
  });

  console.log('Total products:', products.length);
  console.log('Filtered products with featured-small:', newArrivalProducts.length);
  ...
  return (
    <div style={{position: 'relative', bottom: '90px'}} className="uren-product_area">
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-12">
            {/* <div className="section-title_area">
